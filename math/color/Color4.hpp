...
public:
	...
	/**
		...
		*/
	Color4 Lerp(const Color4& other, float progression) const {
	...
	/**
		...
		*/
	Color4 SmoothDamp(const Color4& target, const Color4& rate) const {
	...
	friend Color4 operator+(const Color4& lhs, const Color4& rhs);
	friend Color4 operator-(const Color4& lhs, const Color4& rhs);
	friend Color4 operator*(const Color4& lhs, const Color4& rhs);
	friend Color4 operator/(const Color4& lhs, const Color4& rhs);
	...
	friend Color4 operator*(float lhs, const Color4& rhs);
	friend Color4 operator/(float lhs, const Color4& rhs);
	friend Color4 operator+(const Color4& lhs, float rhs);
	friend Color4 operator-(const Color4& lhs, float rhs);
	friend Color4 operator*(const Color4& lhs, float rhs);
	friend Color4 operator/(const Color4& lhs, float rhs);
