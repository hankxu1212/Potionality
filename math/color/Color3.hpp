...
public:
	...
	/**
		...
		*/
	Color3 Lerp(const Color3& other, float progression) const {
	...
	friend Color3 operator+(const Color3& lhs, const Color3& rhs);
	friend Color3 operator-(const Color3& lhs, const Color3& rhs);
	friend Color3 operator*(const Color3& lhs, const Color3& rhs);
	friend Color3 operator/(const Color3& lhs, const Color3& rhs);
	...
	friend Color3 operator*(float lhs, const Color3& rhs);
	friend Color3 operator/(float lhs, const Color3& rhs);
	friend Color3 operator+(const Color3& lhs, float rhs);
	friend Color3 operator-(const Color3& lhs, float rhs);
	friend Color3 operator*(const Color3& lhs, float rhs);
	friend Color3 operator/(const Color3& lhs, float rhs);
